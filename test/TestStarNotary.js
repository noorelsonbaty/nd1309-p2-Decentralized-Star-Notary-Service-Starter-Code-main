...
it('lets user1 get the funds after the sale', async() => {
    ...
    let gasPrice = web3.utils.toWei("0", "ether");
    await instance.createStar('awesome star', starId, {from: user1});
    await instance.putStarUpForSale(starId, starPrice, {from: user1});
...
it('lets 2 users exchange stars', async() => {
    ...
    let star2Id = 7;
    let gasPrice = web3.utils.toWei("0", "ether");
    await instance.createStar('awesome star1', star1Id, {from: user1});
    await instance.createStar('awesome star2', star2Id, {from: user2});
    await instance.approve(user2, star1Id, { from: user1, gasPrice: gasPrice });
    await instance.approve(user1, star2Id, { from: user2, gasPrice: gasPrice });
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(await instance.lookUptokenIdToStarInfo.call(star1Id), "awesome star"); 
    // 1. create a Star with different tokenId
